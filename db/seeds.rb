...
file = open('https://s3.amazonaws.com/nextup-seed/avenger_end_game.jpg')
marvel.image.attach(io: file, filename: 'avengers.jpg')
file = open('https://s3.amazonaws.com/nextup-seed/Marvel+Studios+Avengers+Endgame+-+Official+Trailer+copy.mp4')
marvel.movie.attach(io: file, filename: 'avengers-trailer.mp4')
